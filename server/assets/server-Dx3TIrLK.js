...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CXC_wjnb.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BE7VNx6U.js").then((n2) => n2.b),
    import("./start-DS2bmg_8.js"),
...
var ROUTER_BASEPATH = "Tender_Management";
var SERVER_FN_BASE = "/Tender_Management/_serverFn/";
