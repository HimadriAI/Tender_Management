...
export type TenderStatus = "Draft" | "Under Review" | "Submitted" | "Won" | "Lost" | "Delayed";
...
export interface Tender {
  ...
  abgAmt: number | "NA";
  abgType: "BG" | "ISB" | "NA";
  bdResponsible: string;     // user id
  supportingLead: string;    // user id
  pmc: string;
...
export const TENDERS: Tender[] = [
  {
    id: "T-2026-001", ref: "TEL/26/001", name: "EPC Package — Hydrocracker Revamp", customer: "Indian Oil Corporation",
    sector: "O&G", state: "Gujarat", location: "Vadodara", jobType: "EPC", jobNature: "Existing",
    publishDate: "2026-01-12", dueDate: "2026-04-18", revisedDueDate: "2026-04-25", bidOpeningDate: "2026-04-26",
    estimateValue: 248.5, supply: 142, service: 38, cs: 22, mech: 36, ei: 10, duration: 24, escalation: "N",
    modeOfBid: "Online", emd: 1.2, emdType: "BG", validity: 180, pbgAmt: 12.4, pbgType: "BG", abgAmt: "NA", abgType: "NA",
    bdResponsible: "u-001", supportingLead: "u-003", pmc: "Engineers India Ltd",
    assignedMembers: ["u-001", "u-002", "u-003", "u-005"], priority: "Critical", status: "Under Review",
    probability: "High", documents: 18, remarks: "High-value strategic bid. Estimate under review.",
    createdBy: "u-001", updatedAt: "2026-05-18T10:20:00Z",
  },
  {
    id: "T-2026-002", ref: "TEL/26/002", name: "Mechanical Maintenance Services — Phase II", customer: "ONGC Mumbai High",
    sector: "O&G", state: "Maharashtra", location: "Mumbai", jobType: "Service", jobNature: "Known",
    publishDate: "2026-02-04", dueDate: "2026-05-22", estimateValue: 86.0, supply: 12, service: 60, cs: 4, mech: 8, ei: 2,
    duration: 36, escalation: "Y", modeOfBid: "Online", emd: 0.5, emdType: "ISB", validity: 120, pbgAmt: 4.3, pbgType: "BG",
    abgAmt: 2.1, abgType: "BG", bdResponsible: "u-001", supportingLead: "u-005", pmc: "—",
    assignedMembers: ["u-001", "u-004", "u-005"], priority: "High", status: "Draft", probability: "Medium",
    documents: 9, remarks: "BOQ pending from client.", createdBy: "u-001", updatedAt: "2026-05-19T08:00:00Z",
  },
  {
    id: "T-2026-003", ref: "TEL/26/003", name: "Urea Plant Revamp — LSTK", customer: "RCF Trombay",
    sector: "Fertilizer", state: "Maharashtra", location: "Trombay", jobType: "LSTK", jobNature: "Known",
    publishDate: "2026-01-30", dueDate: "2026-06-10", estimateValue: 412.0, supply: 240, service: 70, cs: 30, mech: 56, ei: 16,
    duration: 30, escalation: "N", modeOfBid: "Online", emd: 2.0, emdType: "BG", validity: 180, pbgAmt: 20.6, pbgType: "BG",
    abgAmt: 10.3, abgType: "BG", bdResponsible: "u-001", supportingLead: "u-003", pmc: "PDIL",
    assignedMembers: ["u-001", "u-002", "u-003"], priority: "Critical", status: "Submitted", probability: "High",
    documents: 26, remarks: "Awaiting bid opening on 18-Jun.", createdBy: "u-001", updatedAt: "2026-05-20T13:45:00Z",
  },
  {
    id: "T-2026-004", ref: "TEL/26/004", name: "E&I Package — Refinery Expansion", customer: "BPCL Kochi",
    sector: "O&G", state: "Kerala", location: "Kochi", jobType: "EPC", jobNature: "Existing",
    publishDate: "2026-03-02", dueDate: "2026-06-30", estimateValue: 138.0, supply: 78, service: 30, cs: 10, mech: 10, ei: 10,
    duration: 18, escalation: "N", modeOfBid: "Online", emd: 0.7, emdType: "BG", validity: 150, pbgAmt: 6.9, pbgType: "BG",
    abgAmt: "NA", abgType: "NA", bdResponsible: "u-001", supportingLead: "u-005", pmc: "EIL",
    assignedMembers: ["u-001", "u-002", "u-005"], priority: "High", status: "Under Review", probability: "Medium",
    documents: 12, remarks: "Tech bid clarifications.", createdBy: "u-001", updatedAt: "2026-05-15T09:30:00Z",
  },
  {
    id: "T-2026-005", ref: "TEL/26/005", name: "Coker Heater Replacement", customer: "HPCL Vizag",
    sector: "O&G", state: "Andhra Pradesh", location: "Visakhapatnam", jobType: "EPC", jobNature: "Existing",
    publishDate: "2025-12-15", dueDate: "2026-03-30", estimateValue: 72.0, supply: 40, service: 18, cs: 6, mech: 6, ei: 2,
    duration: 14, escalation: "N", modeOfBid: "Online", emd: 0.36, emdType: "BG", validity: 120, pbgAmt: 3.6, pbgType: "BG",
    abgAmt: "NA", abgType: "NA", bdResponsible: "u-001", supportingLead: "u-005", pmc: "—",
    assignedMembers: ["u-001", "u-002"], priority: "Medium", status: "Won", probability: "High",
    documents: 14, remarks: "LOI received.", createdBy: "u-001", updatedAt: "2026-04-30T11:00:00Z",
  },
  {
    id: "T-2026-006", ref: "TEL/26/006", name: "Pipeline Pigging Services", customer: "GAIL India",
    sector: "O&G", state: "Uttar Pradesh", location: "Auraiya", jobType: "Service", jobNature: "Known",
    publishDate: "2026-02-20", dueDate: "2026-04-10", estimateValue: 24.0, supply: 4, service: 18, cs: 1, mech: 1, ei: 0,
    duration: 12, escalation: "Y", modeOfBid: "Online", emd: 0.12, emdType: "ISB", validity: 90, pbgAmt: 1.2, pbgType: "BG",
    abgAmt: "NA", abgType: "NA", bdResponsible: "u-001", supportingLead: "u-003", pmc: "—",
    assignedMembers: ["u-001", "u-004"], priority: "Medium", status: "Lost", probability: "Low",
    documents: 7, remarks: "L2 by 3%.", createdBy: "u-001", updatedAt: "2026-04-22T08:00:00Z",
  },
  {
    id: "T-2026-007", ref: "TEL/26/007", name: "Sulphur Recovery Unit — EPC", customer: "Reliance Jamnagar",
    sector: "O&G", state: "Gujarat", location: "Jamnagar", jobType: "EPC", jobNature: "Existing",
    publishDate: "2026-03-12", dueDate: "2026-07-05", estimateValue: 322.0, supply: 190, service: 56, cs: 22, mech: 40, ei: 14,
    duration: 28, escalation: "N", modeOfBid: "Online", emd: 1.6, emdType: "BG", validity: 180, pbgAmt: 16.1, pbgType: "BG",
    abgAmt: 8.05, abgType: "BG", bdResponsible: "u-001", supportingLead: "u-003", pmc: "EIL",
    assignedMembers: ["u-001", "u-002", "u-003", "u-005", "u-006"], priority: "Critical", status: "Delayed", probability: "Medium",
    documents: 22, remarks: "Awaiting addendum on Section VI.", createdBy: "u-001", updatedAt: "2026-05-21T07:10:00Z",
  },
];

export type OfferStatus = "Drafting" | "Negotiation" | "Sent" | "Accepted" | "Rejected" | "On Hold";
export interface Offer {
  id: string; ref: string; name: string; customer: string; value: number;
  proposalDate: string; validityDate: string; status: OfferStatus; priority: Priority;
  assignedMembers: string[]; remarks: string; documents: number; updatedAt: string;
}
...
export const OFFERS: Offer[] = [
  ...
  { id: "O-2026-005", ref: "OFR/26/005", name: "Piping Fabrication Job", customer: "L&T Hydrocarbon", value: 9.0, proposalDate: "2026-04-08", validityDate: "2026-07-08", status: "Rejected", priority: "Medium", assignedMembers: ["u-001"], remarks: "Lost on price.", documents: 3, updatedAt: "2026-04-30T11:00:00Z" },
...
export type TaskStatus = "Not Started" | "In Progress" | "Under Review" | "Completed" | "Delayed";
export interface Task {
  ...
  assignee: string;
  dueDate: string;
  linkedTo?: string;        // tender/offer id
  progress: number;         // 0-100
  subtasks: { id: string; title: string; done: boolean; assignee: string }[];
  comments: number;
  attachments: number;
  updatedAt: string;
}
...
export interface AppNotification {
  id: string;
  type: "task" | "deadline" | "mention" | "status" | "document" | "approval";
  title: string;
  body: string;
  time: string;
  unread: boolean;
...
export interface RepoFile {
  id: string; name: string; type: "pdf" | "docx" | "xlsx" | "zip" | "pptx" | "image";
  category: string; size: string; uploadedBy: string; uploadedAt: string; version: string;
}
...
export function priorityColor(p: Priority) {
  switch (p) {
    ...
    case "Low": return "bg-slate-500/15 text-slate-700 border-slate-500/30 dark:text-slate-300";
  }
}

export function tenderStatusColor(s: TenderStatus) {
  switch (s) {
    case "Won": return "bg-navy text-navy-foreground border-navy";
    case "Submitted": return "bg-blue-600/15 text-blue-700 dark:text-blue-300 border-blue-600/30";
    case "Under Review": return "bg-amber-500/15 text-amber-700 dark:text-amber-300 border-amber-500/30";
    case "Draft": return "bg-slate-400/15 text-slate-700 dark:text-slate-300 border-slate-400/30";
...
export function offerStatusColor(s: OfferStatus) {
  switch (s) {
    case "Accepted": return "bg-navy text-navy-foreground border-navy";
    case "Sent": return "bg-blue-600/15 text-blue-700 dark:text-blue-300 border-blue-600/30";
    case "Negotiation": return "bg-amber-500/15 text-amber-700 dark:text-amber-300 border-amber-500/30";
    case "Drafting": return "bg-slate-400/15 text-slate-700 dark:text-slate-300 border-slate-400/30";
    case "Rejected": return "bg-destructive/15 text-destructive border-destructive/30";
    case "On Hold": return "bg-slate-500/15 text-slate-700 dark:text-slate-300 border-slate-500/30";
  }
}

export function taskStatusColor(s: TaskStatus) {
  switch (s) {
    case "Completed": return "bg-navy text-navy-foreground border-navy";
    case "Under Review": return "bg-blue-600/15 text-blue-700 dark:text-blue-300 border-blue-600/30";
    case "In Progress": return "bg-amber-500/15 text-amber-700 dark:text-amber-300 border-amber-500/30";
    case "Not Started": return "bg-slate-400/15 text-slate-700 dark:text-slate-300 border-slate-400/30";
    case "Delayed": return "bg-destructive/15 text-destructive border-destructive/30";
  }
}

export const TASK_STATUSES: TaskStatus[] = ["Not Started", "In Progress", "Under Review", "Completed", "Delayed"];
